...
$user = $row['user'];
$tiim = time();
$orgt = (int) sanitizeString($_POST['t']);
$orgt += 20;
$pu = $_SESSION['user'];
    $surelyoccured = '';
    $ssurelyoccured = '';
...
AND timeofupdate BETWEEN $orgt AND $tiim
    UNION ALL
      ...
      AND timeofupdate BETWEEN $orgt AND $tiim ORDER BY RAND() LIMIT 15");
   }
  // friends suggestion
  /*
